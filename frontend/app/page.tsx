            ...
            <div className="flex flex-col lg:flex-row items-center">
              ...
              <div className="lg:w-3/5 lg:pl-12">
                ...
                <p className="text-gray-700 mb-6">
                  Our innovative system combines traditional databases with
                  blockchain technology to create tamper-proof records of
                  critical air pollution events while efficiently managing
                  regular air quality data.
                </p>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start">
                    ...
                    <p className="text-gray-700">
                      <span className="font-medium">Immutable Records</span> of
                  ...
                  <div className="flex items-start">
                    ...
                    <p className="text-gray-700">
                      <span className="font-medium">Hybrid Storage</span> for
                ...
                <div className="flex space-x-4">
                  ...
                  <Link
                    href="#features"
                    className="border border-gray-300 hover:border-gray-400 px-6 py-2 rounded-md transition duration-300"
                  >
                    Learn More
                  </Link>
                </div>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700">
                  Collect and process air quality data from multiple sensors
                  measuring PM2.5, PM10, ozone, and other pollutants.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700">
                  Store regular readings in Supabase and critical events on
                  Polygon blockchain for maximum efficiency and security.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700">
                  Access real-time air quality data through an intuitive
                  dashboard with verified blockchain records of pollution
                  events.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-gray-400">
                  Transparent air quality monitoring combining blockchain and
